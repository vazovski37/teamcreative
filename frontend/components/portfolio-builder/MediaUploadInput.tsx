...
export function MediaUploadInput({ label, value, onChange, placeholder, required }: MediaUploadInputProps) {
    ...
    const isUploaded = value.startsWith('blob:') || value.startsWith('data:');
        ...
        <div className="space-y-1.5">
            ...
            <div className="flex gap-1.5">
                ...
                <button
                    ...
                    className="px-3 py-2 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 text-gray-400 hover:text-white transition-colors flex items-center gap-1.5 shrink-0"
                >
                    <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
